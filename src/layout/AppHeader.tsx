...
const AppHeader: React.FC = () => {
  ...
  const [mounted, setMounted] = useState(false); // ← client-only mount gate
  ...
  // Avoid SSR entirely for the header to prevent hydration mismatches from extensions
  ...
  return (
    <header className="sticky top-0 z-50 flex w-full bg-white border-gray-200 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        {/* Left: burger, logo, search (mobile buttons) */}
